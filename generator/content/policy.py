...
def _privacy(cfg) -> PolicyDoc:
    ...
    return PolicyDoc(
        ...
        sections=(
            ...
            _S(
                "P4", "p4", "제3자·비개인화", "제3자 처리·비개인화 광고",
                (
                    "Google 등 제3자가 쿠키를 통해 광고·분석 목적의 정보를 처리할 수 "
                    "있습니다. 본 사이트는 개인화(맞춤형) 광고를 요청하지 않으며, 광고를 "
                    "부를 때 항상 비개인화 광고로 요청합니다. 그래서 개인화 광고 동의를 "
                    "따로 받지 않습니다.",
                    "광고 쿠키를 관리하거나 개인화 광고를 완전히 거부하려면 아래 외부 "
                    "페이지를 이용해 주세요. 브라우저의 쿠키 차단 설정으로도 거부할 수 "
                    "있습니다.",
                ),
                cross_route="/ads",
            ...
            _S(
                ...
                (
                    "광고를 거부하거나 쿠키를 차단하더라도 사이트 이용에는 제한이 없으며, "
                    "광고가 표시되지 않거나 관련성이 낮은 광고가 표시될 수 있습니다.",
                ),
            ),
            _S(
    ...
    return PolicyDoc(
        ...
        sections=(
            ...
            _S(
                ...
                (
                    "광고 게재를 위해 Google 등 제3자가 쿠키를 사용할 수 있습니다. 본 "
                    "사이트는 개인화(맞춤형) 광고를 요청하지 않고 항상 비개인화 광고로 "
                    "요청하며, 그래서 개인화 광고 동의를 따로 받지 않습니다. 자세한 내용은 "
                    "개인정보처리방침을 확인해 주세요.",
                    "광고 쿠키 관리·개인화 광고 거부는 아래 외부 페이지에서 할 수 "
                    "있습니다.",
                ),
                cross_route="/privacy",
                external_links=OPT_OUT_LINKS,
