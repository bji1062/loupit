...
KNOWN_NOT_TOTAL = {
    ...
    # ── 확장 웨이브 3(2026-09-15 원문 확인) — `--corp` 수집 경고 3사. 전부 이름 붙은 합계행이 없고 부문 중 하나다.
    ("00113207", "관리직"): "대한전선 2018~2021 관리직 435·430·417·446 vs 현장직/기능직 431·433·426·437 — 부문이 둘뿐인 쌍",
    ("00113207", "기능직"): "대한전선 2019~2021 기능직 433·426·437 vs 관리직 430·417·446 — 위와 같은 쌍의 반대편",
    ("00113207", "현장직"): "대한전선 2018 현장직 431 vs 관리직 435 — 2018 표기(2019 부터 기능직), 쌍의 반대편",
...
KNOWN_TOTAL = {
    ...
    # 에스티팜(확장 웨이브 3, 2026-09-15 원문 확인): 2016~2025 매년 `전체` 행을 부문행과 **함께** 낸다.
    # 2025 전체 남 559 + 여 221 = 780 == 사무/영업 89 + 연구/개발 104 + 품질/생산 587 — 표식 없이 적재하면 1,560 명(정확히 두 배).
    ("00871833", "전체"): "에스티팜 2016~2025 전체 == 부문 합(2025 전체 780 = 사무/영업 89 + 연구/개발 104 + 품질/생산 587)",
}
