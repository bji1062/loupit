...
VALUES
  ...
  (@comp_id, 'parenting', '임신·출산·육아', NULL, 'family',
   'est', NULL, TRUE, '육아휴직 자녀당 최대 2년 6개월 중 회사 지원 추가 1년, 임신 12~36주 중 8주간 1일 2시간 단축근무, 출산 후 3개월간 1일 2시간 단축근무, 배우자 출산휴가 회사 지원 추가 최대 14일, 난임휴직, 임신 축하 선물 약 12만원 상당, 자녀 수능 선물 약 3만원 상당과 대표이사 응원 카드', 40),
