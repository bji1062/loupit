...
-- ⚠ 데이터 정리 2차(2026-09-21): SORT 53 문안 교체. db/migrations/20260921_data_cleanup_2.sql 동봉.
-- 1) 회사 등록 (없는 경우)
...
VALUES
  ...
  -- ── 시간·휴가 (time_off) ──
  (@comp_id, 'leave_general', '창립기념일 휴무·경조휴가', NULL, 'time_off',
   'est', NULL, TRUE, '창립기념일 휴무 및 경조휴가 운영', 30),
