...
-- CJ대한통운 복리후생 데이터
-- 출처: AI 파싱 (2026-07-30)
-- URL: https://cjlrecruit.com/lifeandbenefit
...
-- 자사 채용 Life & Benefit 페이지 기준.
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
-- ⚠ 법정 제도 문구 정리(2026-09-20): SORT 40 문안 교체 — 법정 제도 서술을 걷고 회사 상회분만 남겼다. 행 수 변동 없음.

INSERT IGNORE INTO TCOMPANY (COMP_ENG_NM, COMP_NM, COMP_TP_ID, INDUSTRY_NM, LOGO_NM, CAREERS_BENEFIT_URL)
VALUES ('cj_logistics', 'CJ대한통운',
        (SELECT COMP_TP_ID FROM TCOMPANY_TYPE WHERE COMP_TP_CD = 'large'),
        '물류', 'C', 'https://cjlrecruit.com/lifeandbenefit');

SET @comp_id = (SELECT COMP_ID FROM TCOMPANY WHERE COMP_ENG_NM = 'cj_logistics');
...
VALUES
  ...
  -- ── 시간·휴가 (time_off) ──
  (@comp_id, 'long_service_leave', '자기계발 기간(CREATIVE WEEK)', NULL, 'time_off',
   'est', NULL, TRUE, '근속연수에 따라 최대 4주', 20),
  -- ── 건강·의료 (health) ──
  ...
  (@comp_id, 'career', '국제 파견 프로그램', NULL, 'growth',
   'est', NULL, TRUE, '해외법인 단기 파견', 52),
  -- ── 여가·라이프 (leisure) ──
