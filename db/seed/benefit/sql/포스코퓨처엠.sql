...
VALUES
  ...
  (@comp_id, 'leave_general', '권장휴가·저축휴가·시간단위 휴가', NULL, 'time_off',
   'est', NULL, TRUE, '권장휴가, 저축휴가제도 운영과 반차제도, 4시간 이내 시간단위 휴가사용 제도, 연차휴가 조기사용 제도 (공식 인사제도 페이지 복리후생 휴가제도 항목 — 권장휴가 일수·저축 한도 미기재)', 70),
