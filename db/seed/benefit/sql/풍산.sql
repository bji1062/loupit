...
VALUES
  ...
  (@comp_id, 'welfare_fund_loan', '사내 근로복지기금 대출', NULL, 'perks',
   'est', NULL, TRUE, '공식 채용정보 복지제도 페이지 회사생활 항목명은 자금 지원이고 내용은 사내 근로복지기금 운영. 2025 지속가능경영보고서 66쪽 기타 지원 항목이 복지기금 대출로 기재 — 대출 한도·이율·대상 미기재', 13),
  (@comp_id, 'telecom', '통신비 지원', NULL, 'perks',
   'est', NULL, TRUE, '2025 지속가능경영보고서 66쪽 복리후생 제도 표 기타 지원 항목의 통신비 지원 (2025년 기준) — 지원 금액·대상 직군 미기재', 14),
  ...
  (@comp_id, 'summer_leave', '하기휴가', NULL, 'time_off',
   'est', NULL, TRUE, '공식 채용정보 복지제도 페이지 여가 항목 휴가제도의 하기휴가. 2025 지속가능경영보고서 66쪽 휴가 제도 항목에도 하계휴가 기재 — 휴가 일수·사용 시기 미기재', 60),
  (@comp_id, 'leave_general', '자기계발휴가', NULL, 'time_off',
   'est', NULL, TRUE, '공식 채용정보 복지제도 페이지 여가 항목 휴가제도의 자기계발휴가. 2025 지속가능경영보고서 66쪽 휴가 제도 항목에도 자기계발 휴가 기재 — 부여 일수·사용 조건 미기재', 61),

  -- ── 유연근무 (flexibility) ──
  (@comp_id, 'flex_work', '유연근무제', NULL, 'flexibility',
   'est', NULL, TRUE, '2025 지속가능경영보고서 66쪽 복리후생 제도 표 유연근무제 운영 항목의 시차출퇴근제와 선택적근로시간제 (2025년 기준) — 신청 대상·운영 단위 미기재', 70),
  (@comp_id, 'remote_work', '재택근무', NULL, 'flexibility',
   'est', NULL, TRUE, '2025 지속가능경영보고서 66쪽 유연근무제 운영 항목의 재택근무 (2025년 기준) — 가능 일수·대상 직무 미기재', 71),

  -- ── 건강·의료 (health) ──
  (@comp_id, 'health_check', '종합건강검진 (본인·배우자)', NULL, 'health',
   'est', NULL, TRUE, '2025 지속가능경영보고서 66쪽 건강관리 지원 항목의 본인·배우자 종합건강검진 지원 (2025년 기준) — 검진 주기·검진 비용 미기재', 80),
  (@comp_id, 'insurance', '단체보험', NULL, 'health',
   'est', NULL, TRUE, '2025 지속가능경영보고서 66쪽 건강관리 지원 항목 기준 전 임직원 대상 상해장애·상해사망·산재사망·질병사망 보험금 지급 (2025년 기준) — 보장 한도·보험료 부담 미기재', 81),
  ...
  (@comp_id, 'retirement_support', '퇴직자 재취업 지원', NULL, 'growth',
   'est', NULL, TRUE, '2025 지속가능경영보고서 66쪽 복리후생 제도 표 기준 퇴직 예정인 만 50세 이상 근로자를 위한 재취업 지원 서비스 (2025년 기준), 공식 채용정보 복지제도 페이지 회사생활 항목 기준 정년 앞둔 장기근속자 공로여행(유급휴가·여행 경비 지원) — 서비스 내용·기간·휴가 일수·여행 경비 한도 미기재', 91)
