...
--
-- 무엇을 바꾸나:
--   NAVER stock_grant 1,000 → 금액 없음 · 이름 주식 지급(Stock Grant). 2025 통합보고서 p.205 이사회 안건
--     2025-01-02 Stock Grant 지급을 위한 자사주 처분 가결 — 제도는 있으나 대상과 금액은 현행 공식 출처
--     (채용 사이트 · 보고서)에 없다. 전 직원 · 1,000만원은 근거가 없어 걷는다.
