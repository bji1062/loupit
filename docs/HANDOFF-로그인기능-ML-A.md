...
> **⚠ 재개 진입점은 이 문서가 아니라 `docs/HANDOFF-2026-07-27.md` 다.**
> 거기에 서버 인프라(100GB 볼륨·MySQL 이전·스왑·OOM)와 Resend 메일 연동 진행 상황,
> 그리고 다음 세션이 바로 이어서 할 절차(§3)가 있다. 본 문서는 SC14 설계 정본으로 참조하라.
