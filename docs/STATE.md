...
| 테스트 | 백엔드 **671** · sc14 3 · 생성기 **292** · 프론트 **783** — 통합 브랜치 `lane/integration-2026-08-27` 실측(커뮤니티 +74·재무 +37·탭/정책 +38·프론트 +75) | 2026-08-27 |
...
| **히트맵(SC16 신설)** | `/heatmap` 복지·실적 히트맵 — KRX 업종(종목코드 자동 매칭 100/102)·squarify 정적 배치·가로/세로·7단계 색·상단 탭 `히트맵`. [SP-HEAT](SPEC/16-히트맵.md) · **라이브(PR #12)** TASK/16 8/8. 비교판 3종(대분류 10 / 업종 67 / KRX)을 실데이터로 만들어 KRX 로 확정 | 2026-08-27 |
