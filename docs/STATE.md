...
| **광고 동의 배너** | **제거(2026-08-28)** — 광고는 항상 비개인화 요청(`requestNonPersonalizedAds=1` 상수). 정본 [DECISION-동의배너-제거](DECISION-동의배너-제거-2026-08-28.md). ⚠ AdSense 승인 후 개인화를 켜려면 **구글 인증 CMP**(Privacy & messaging) 먼저 — 자체 배너 부활 금지(GC-24 가 막는다) | 2026-08-28 |
