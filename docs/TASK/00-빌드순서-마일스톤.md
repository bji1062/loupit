...
| **M1** 데이터 계층 | SP-DB → SP-SEED | `schema.sql` 5테이블·`AMT_SOURCE_CD`·백필 DDL → `reference.sql`·96 복지 재이식(→95 등록)·회사≈95 매핑·프리셋 28·DEC-2 백필·`load.py` | M0 + **DG-1·DG-2·DG-3 해소** | SD-3·DC-2·DC-12·DC-13·SB-1·SB-6 | - [ ] |
