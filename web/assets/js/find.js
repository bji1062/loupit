...
// 손으로 못 박는 표시명(`generator/pages/find.py::LABEL_OVERRIDE` 와 같은 아홉 줄). 두 갈래다:
...
// ② 빈도 1순위가 한 그룹의 표기(CJ 7개사 공통 문구)라 항목 전체의 이름이 된 코드를 일반명으로(뒤 네 줄,
//   2026-09-18) — 「CJ 계열사 할인」이 할인 45곳 전체의 이름이 되어 있었다.
